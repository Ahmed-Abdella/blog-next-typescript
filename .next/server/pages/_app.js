...
function NavLink({ href , children  }) {
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx((link_default()), {
        className: `px-2 py-1 font-base hover:text-gray-900 transition duration-100 rounded-md ${href === router.pathname ? "text-cyan-500  hover:text-cyan-500" : ""} `,
        href: href,
        children: children
    });
}
...
var __webpack_exports__ = __webpack_require__.X(0, [121,675,676,664], () => (__webpack_exec__(8513)));
